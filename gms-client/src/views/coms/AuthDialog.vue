    ...
    export default {
        ...
        methods: {
            ...
            queryAuth(tempAuthList) {
                this.$http.post("/mid-user/auth/selectByRoleId", qs.stringify({roleIdList: [this.roleId].join(",")})).then(res => {
            ...
            addOrDel(del, id) {
                ...
                this.$http.post("/mid-user/relRoleAuth/" + operation, qs.stringify(params)).then(res => {
                    if (res.data.result && res.data.data) {
