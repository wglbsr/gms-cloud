...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            insert() {
                let that = this;
                that.$http.post("/role/create", that.roleObj).then(res => {
                    if (res.data.result && res.data.data) {
            ...
            update() {
                let that = this;
                that.$http.post("/role/update", that.roleObj).then(res => {
                    if (res.data.result && res.data.data) {
            ...
            activate(activate, id) {
                ...
                this.$http.post("/role/activate", qs.stringify(params)).then(res => {
                    if (res.data.result && res.data.data) {
