...
public class CableData {
    ...
    private String beginTime = null;//	开始发电时间	yyyy-mm-dd hh:mm:ss	状态0、1有值，其它为空
    private String endtime = null;//	停止发电时间	yyyy-mm-dd hh:mm:ss	状态0有值，其它为空
    private String updateTime = null;//	   更新时间	yyyy-mm-dd hh:mm:ss	必填
    private String sid = null;//	LAC/SID	局站BID 号,lac	必填
    private String bid = null;//	CellID/BID	局站BID 号,cell
    private String lng = null;//	经度	基站经度（106.80407）保留6位小数	非必填
    private String lat = null;//	纬度	基站纬度（30.65591）保留6位小数
    private String spLng = null;//	发电机经度	发电机经度（106.80407）保留6位小数	必填
    private String spLat = null;//	发电机纬度	发电机纬度（30.65591）保留6位小数	必填
    private Integer distance = null;//	距离	发电机与基站距离	非必填
    private Float oilCost = null;//	油耗	油耗（L/H）	必填
    private String mnc = null;//	网络类型	例如：4G网络	非必填
